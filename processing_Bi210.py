...
for x in range(0,20):
	...
	inFileStr=inFileStr.replace("cp BiPo212_FromOP_140.ntuple.root /data/snoplus/liggins/year1/fitting/alphaBetaClassifier/output/","cp Bi210_"+str(x)+".ntuple.root /data/snoplus/liggins/year1/fitting/alphaBetaClassifier/output/")
	outFile.write(inFileStr)
#
#	
#
